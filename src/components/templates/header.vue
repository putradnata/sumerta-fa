<template>
  <nav id="top-bar" class="bg-white fixed w-full z-10 top-0 shadow">
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
      ...
      <div class="w-1/2 pl-2 md:pl-0">
        <a class="text-gray-900 text-base xl:text-xl no-underline hover:no-underline font-bold" href="#">
          <i class="fas fa-sun text-pink-600 pr-3"></i> Sumerta
        </a>
      </div>
      ...
      <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20"
        ...
        <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
          <li class="mr-6 my-2 md:my-0">
            <router-link to="/admin" class="block py-1 md:py-3 pl-1 align-middle no-underline hover:text-gray-900">
              <i class="fas fa-columns mr-3 text-pink-600"></i>&nbsp; Home
            </router-link>
          </li>
          <li>
            <router-link to="/admin/banjar" class="block py-1 md:py-3 pl-1 align-middle no-underline hover:text-gray-900">
              <i class="fas fa-home fa-fw mr-3 text-pink-600"></i>&nbsp;Banjar
            </router-link>  
          </li>
        </ul>
